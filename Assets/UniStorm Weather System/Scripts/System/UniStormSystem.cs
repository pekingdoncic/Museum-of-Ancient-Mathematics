...
namespace UniStorm
{
    public class UniStormSystem : MonoBehaviour
    {
        ...
        public TMP_Text HourTextShow;
        public TMP_Text MinuteTextShow;
        //Editor
        ...
        void CreateUniStormMenu()
        {
            ...
            HourTextShow = GameObject.Find("HourText").GetComponent<TMP_Text>();
            HourTextShow.text = UniStormSystem.Instance.Hour.ToString();

            MinuteTextShow = GameObject.Find("MinuteText").GetComponent<TMP_Text>();
            MinuteTextShow.text = UniStormSystem.Instance.Minute.ToString();
